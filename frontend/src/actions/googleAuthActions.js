...
const DJANGO_CLIENT_SECRET = process.env.DJANGO_CLIENT_SECRET;

export const django_client_id = DJANGO_CLIENT_ID;
export const django_client_secret = DJANGO_CLIENT_SECRET;
