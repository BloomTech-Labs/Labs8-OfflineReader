(function webpackUniversalModuleDefinition(root, factory) {
  ...
  else root["ReactStripeElements"] = factory(root["React"]);
  ...
  return /******/ (function(modules) {
    ...
    /******/ [
      ...
      /***/ function(module, exports, __webpack_require__) {
        ...
        var Elements = (function(_React$Component) {
          ...
          function Elements(props, context) {
            ...
            _this.handleRegisterElement = function(
              element,
              impliedTokenType,
              impliedSourceType
            ) {
              _this.setState(function(prevState) {
                return {
                  registeredElements: [].concat(
                    _toConsumableArray(prevState.registeredElements),
                    [
                      _extends(
                        {
                          element: element
        ...
        Elements.childContextTypes = _extends(
          {},
          injectContextTypes,
          elementContextTypes
        );
      ...
      /***/ function(module, exports, __webpack_require__) {
        ...
        var getOrCreateStripe = function getOrCreateStripe(apiKey, options) {
          ...
          window.Stripe.__cachedInstances =
            window.Stripe.__cachedInstances || {};
          var cacheKey =
            "key=" + apiKey + " options=" + JSON.stringify(options);
      ...
      /***/ function(module, exports, __webpack_require__) {
        ...
        var _PaymentRequestButtonElement2 = _interopRequireDefault(
          _PaymentRequestButtonElement
        );
        ...
        exports.PaymentRequestButtonElement =
          _PaymentRequestButtonElement2.default;
      ...
      /***/ function(module, exports, __webpack_require__) {
        ...
        var inject = function inject(WrappedComponent) {
          ...
          var _componentOptions$wit = componentOptions.withRef,
            withRef =
              _componentOptions$wit === undefined
                ? false
                : _componentOptions$wit;
          ...
          return (
              ...
              function _class(props, context) {
                ...
                _this.findElement = function(filterBy, specifiedType) {
                  ...
                  var matchingElements =
                    specifiedType === "auto"
                      ? filteredElements
                      : filteredElements.filter(function(e) {
                ...
                _this.wrappedCreateToken = function(stripe) {
                  return function() {
                    ...
                    if (
                      tokenTypeOrOptions &&
                      (typeof tokenTypeOrOptions === "undefined"
                        ? "undefined"
                        : _typeof(tokenTypeOrOptions)) === "object"
                    ) {
                      ...
                      var element = _this.requireElement(
                        "impliedTokenType",
                        specifiedType
                      );
                      ...
                      if (typeof options.type !== "string") {
                        throw new Error(
                          "Invalid Source type passed to createSource. Expected string, got " +
                            _typeof(options.type) +
                            "."
                        );
                      }

                      var element = _this.findElement(
                        "impliedSourceType",
                        options.type
                      );
                      if (element) {
            ...
            (_class.contextTypes = _extends(
              {},
              _Provider.providerContextTypes,
              _Elements.injectContextTypes
            )),
            (_class.displayName =
              "InjectStripe(" +
      ...
      /***/ function(module, exports, __webpack_require__) {
        ...
        var _extractOptions = function _extractOptions(props) {
          var id = props.id,
            ...
            options = _objectWithoutProperties(props, [
              "id",
              "className",
              "onChange",
              "onFocus",
        ...
        var Element = function Element(type) {
          ...
          return (
            (_temp = _class = (function(_React$Component) {
              ...
              _class.prototype.componentDidMount = function componentDidMount() {
                ...
                this.context.addElementsLoadListener(function(elements) {
                  ...
                  if (
                    ...
                    _this2.context.registerElement(
                      element,
                      hocOptions.impliedTokenType,
                      hocOptions.impliedSourceType
                    );
              ...
              _class.prototype.componentWillReceiveProps = function componentWillReceiveProps(
                ...
                if (
                  ...
                  !(0, _shallowEqual2.default)(options, this._options)
                ) {
              ...
              _class.prototype._setupEventListeners = function _setupEventListeners(
                element
              ) {
                var _this3 = this;
                ...
                element.on("blur", function() {
                  ...
                  return (_props = _this3.props).onBlur.apply(
                    _props,
                    arguments
                  );
                });
                element.on("focus", function() {
                  ...
                  return (_props2 = _this3.props).onFocus.apply(
                    _props2,
                    arguments
                  );
                });
            ...
            (_class.contextTypes = _Elements.elementContextTypes),
            (_class.displayName = capitalized(type) + "Element"),
            _temp
          );
        };
      ...
      /***/ function(module, exports, __webpack_require__) {
        ...
        var PaymentRequestButtonElement = (function(_React$Component) {
          ...
          PaymentRequestButtonElement.prototype.componentDidMount = function componentDidMount() {
            ...
            this.context.addElementsLoadListener(function(elements) {
              _this2._element = elements.create(
              ...
              _this2._element.on("click", function() {
                ...
                return (_props2 = _this2.props).onClick.apply(
                  _props2,
                  arguments
                );
              });
              _this2._element.on("blur", function() {
                ...
                return (_props3 = _this2.props).onBlur.apply(
                  _props3,
                  arguments
                );
              });
          ...
          PaymentRequestButtonElement.prototype.componentWillReceiveProps = function componentWillReceiveProps(
            nextProps
          ) {
