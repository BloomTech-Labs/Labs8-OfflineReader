!(function(e, t) {
  "object" == typeof exports && "object" == typeof module
    ...
    ? (exports.ReactStripeElements = t(require("react")))
    : (e.ReactStripeElements = t(e.React));
})(this, function(e) {
  return (function(e) {
    function t(r) {
    ...
    function(e, t, n) {
      ...
      var p =
        ...
        d = r(f),
        y = n(3),
        h = (t.injectContextTypes = {
          getRegisteredElements: d.default.func.isRequired
        }),
        m = (t.elementContextTypes = {
          addElementsLoadListener: d.default.func.isRequired,
          registerElement: d.default.func.isRequired,
          unregisterElement: d.default.func.isRequired
        }),
        v = (function(e) {
          function t(n, r) {
            s(this, t);
            ...
            return (
              (o.handleRegisterElement = function(e, t, n) {
                o.setState(function(r) {
                  return {
                    registeredElements: [].concat(i(r.registeredElements), [
                      p(
                        { element: e },
            ...
            (t.prototype.getChildContext = function() {
              ...
              return {
                addElementsLoadListener: function(t) {
                  if (e._elements) return void t(e._elements);
                  var n = e.props,
                    r = o(n, ["children"]);
                  "sync" === e.context.tag
      ...
      (v.childContextTypes = p({}, h, m)),
        (v.contextTypes = y.providerContextTypes),
    ...
    function(e, t, n) {
      ...
      var u = n(0),
        ...
        c = n(1),
        l = r(c),
        f = (t.providerContextTypes = {
          tag: l.default.string.isRequired,
          stripe: l.default.object,
          addStripeLoadListener: l.default.func
        }),
        d = function(e, t) {
        ...
        h = (function(e) {
          function t(n) {
            ...
            if (r.props.apiKey) {
              ...
              var a = r.props,
                u = a.apiKey,
                p = o(a, ["apiKey", "children", "stripe"]);
              r._meta = { tag: "sync", stripe: d(u, p) };
            } else if (r.props.stripe)
              r._meta = { tag: "sync", stripe: y(r.props.stripe) };
            else {
          ...
          return (
            ...
            (t.prototype.render = function() {
              return p.default.Children.only(this.props.children);
            }),
            t
          );
        })(p.default.Component);
    ...
    function(e, t, n) {
      ...
      var o = n(3),
        ...
        h = (0, l.default)("cardNumber", {
          impliedTokenType: "card",
          impliedSourceType: "card"
        }),
        m = (0, l.default)("cardExpiry"),
        v = (0, l.default)("cardCvc"),
        b = (0, l.default)("postalCode"),
        _ = (0, l.default)("iban", {
          impliedTokenType: "bank_account",
          impliedSourceType: "sepa_debit"
        }),
        g = (0, l.default)("idealBank", { impliedSourceType: "ideal" });
      (t.StripeProvider = i.default),
        (t.injectStripe = a.default),
        (t.Elements = p.default),
        (t.CardElement = y),
        (t.CardNumberElement = h),
        (t.CardExpiryElement = m),
        (t.CardCVCElement = v),
        (t.PostalCodeElement = b),
        (t.PaymentRequestButtonElement = d.default),
        (t.IbanElement = _),
        (t.IdealBankElement = g);
    },
    function(e, t, n) {
      "use strict";
      var r = n(7),
            ...
            function n(e, s) {
              ...
              return (
                (a.findElement = function(e, t) {
                  ...
                  if (1 === o.length) return o[0].element;
                  if (o.length > 1)
                    throw Error(
                  ...
                  return function() {
                    ...
                    if (t && "object" === (void 0 === t ? "undefined" : u(t))) {
                      var o = t,
                        ...
                        c = a.requireElement("impliedTokenType", p);
                      return e.createToken(c, s);
                    }
                    if ("string" == typeof t) {
                      return e.createToken(t, n);
                    }
                    throw Error(
      ...
      t.default = function(e) {
        ...
        return (
          (n = t = (function(t) {
            function n(e, r) {
              o(this, n);
              var s = i(this, t.call(this, e, r));
              (s.handleRef = function(e) {
                s._ref = e;
              }),
                (s._element = null);
              var a = m(s.props);
              return (s._options = a), s;
            }
            return (
              s(n, t),
              (n.prototype.componentDidMount = function() {
                ...
                this.context.addElementsLoadListener(function(n) {
                  var o = n.create(e, t._options);
                  (t._element = o),
                    t._setupEventListeners(o),
                    o.mount(t._ref),
                    (r.impliedTokenType || r.impliedSourceType) &&
          ...
          (t.contextTypes = y.elementContextTypes),
          (t.displayName = v(e) + "Element"),
          n
        );
      };
    },
    function(e, t, n) {
            ...
            (t.prototype.componentDidMount = function() {
              ...
              this.context.addElementsLoadListener(function(t) {
                (e._element = t.create(
                  ...
                  u({ paymentRequest: e.props.paymentRequest }, e._options)
                )),
      ...
      (b.propTypes = {
        ...
        onReady: f.default.func,
        paymentRequest: f.default.shape({
          canMakePayment: f.default.func.isRequired,
          on: f.default.func.isRequired,
          show: f.default.func.isRequired
        }).isRequired
      }),
        (b.defaultProps = {
          id: void 0,
        ...
        (b.contextTypes = h.elementContextTypes),
        (t.default = b);
    }
  ]);
});
