...
describe("Element", function() {
  ...
  it("should pass id to the DOM element", function() {
    ...
    var element = (0, _enzyme.shallow)(
      _react2.default.createElement(CardElement, { id: id }),
      { context: context }
    );
  ...
  it("should pass className to the DOM element", function() {
    ...
    var element = (0, _enzyme.shallow)(
      _react2.default.createElement(CardElement, { className: className }),
      { context: context }
    );
  ...
  it("should call the right hooks for a registered Element", function() {
    ...
    var element = (0, _enzyme.mount)(
      _react2.default.createElement(TestElement, { onChange: jest.fn() }),
      { context: context }
    );
  ...
  it("should call onReady", function() {
    ...
    (0, _enzyme.mount)(
      _react2.default.createElement(CardElement, { onReady: onReadyMock }),
      {
        context: context
      }
    );
  ...
  it("should update the Element when props change", function() {
    ...
    var element = (0, _enzyme.mount)(
      _react2.default.createElement(TestElement, {
        onChange: jest.fn(),
        style: style
      }),
      {
  ...
  it("re-rendering with new props should still work if addElementsLoadListener hasn't fired yet", function() {
    ...
    var element = (0, _enzyme.shallow)(
      _react2.default.createElement(CardElement, { placeholder: placeholder }),
      {
        context: context
      }
    );
