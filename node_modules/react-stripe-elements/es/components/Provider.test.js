...
describe("StripeProvider", function() {
  ...
  it("requires apiKey or stripe prop", function() {
    expect(function() {
      (0,
      _enzyme.shallow)(_react2.default.createElement(_Provider2.default, null, _react2.default.createElement("div", null)));
  ...
  it("throws without stripe.js loaded if using apiKey", function() {
    ...
    expect(function() {
      return (0,
      _enzyme.shallow)(_react2.default.createElement(_Provider2.default, { apiKey: "made_up_key" }));
    }).toThrow(
  ...
  it("requires not both apiKey and stripe prop", function() {
    expect(function() {
      (0,
      _enzyme.shallow)(_react2.default.createElement(_Provider2.default, { apiKey: "made_up_key", stripe: stripeMockResult }, _react2.default.createElement("div", null)));
    }).toThrow(
  ...
  it("throws with more than one children", function() {
    expect(function() {
      return (0,
      _enzyme.shallow)(_react2.default.createElement(_Provider2.default, { apiKey: "made_up_key" }, _react2.default.createElement("div", null), _react2.default.createElement("div", null)));
    }).toThrow(
      "React.Children.only expected to receive a single React element child"
    );
  });
