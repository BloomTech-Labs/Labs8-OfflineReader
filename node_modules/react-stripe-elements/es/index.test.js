  ...
  var WrappedCheckout = function WrappedCheckout(type, additionalOptions) {
    var MyCheckout = function MyCheckout(props) {
      return _react2.default.createElement(
        ...
        props.children,
        _react2.default.createElement("button", null, "Pay")
      );
    };
      ...
      var app = (0, _enzyme.mount)(
        _react2.default.createElement(
          ...
          _react2.default.createElement(
            _index.Elements,
            null,
            _react2.default.createElement(Checkout, null, "Hello world")
          )
        )
      );
      app.find("form").simulate("submit");
  ...
  describe("errors", function() {
    ...
    describe("createToken", function() {
      it("should throw when not in Elements", function() {
        ...
        expect(function() {
          return (0,
          _enzyme.mount)(_react2.default.createElement(_index.StripeProvider, { apiKey: "pk_test_xxx" }, _react2.default.createElement(Checkout, null, _react2.default.createElement(_index.Elements, null, _react2.default.createElement(_index.CardElement, null)))));
