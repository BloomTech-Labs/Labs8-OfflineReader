...
describe("injectStripe()", function() {
  ...
  describe("[sync]", function() {
    ...
    it("sets the correct displayName", function() {
      expect((0, _inject2.default)(WrappedComponent).displayName).toBe(
    ...
    it("throws when StripeProvider is missing from ancestry", function() {
      ...
      expect(function() {
        return (0,
        _enzyme.shallow)(_react2.default.createElement(Injected, null));
      }).toThrow(
    ...
    it("renders <WrappedComponent> with `stripe` prop", function() {
      ...
      var wrapper = (0, _enzyme.shallow)(
        _react2.default.createElement(Injected, null),
        {
          context: context
        }
      );
    ...
    it("`getWrappedInstance` works whith `{withRef: true}` option.", function() {
      ...
      var WrappedClassComponent = (function(_React$Component) {
        ...
        WrappedClassComponent.prototype.render = function render() {
          return _react2.default.createElement("div", null, this.foo);
        };
      ...
      var Injected = (0, _inject2.default)(WrappedClassComponent, {
        withRef: true
      });
